...
public class kakaopayService {
    ...
    private HttpEntity<Map<String, String>> getRequestEntity(Booking booking) {
        ...
        parameters.put("approval_url", "http://192.168.113.76:8080/payment/success"); // 성공 시 redirect url
        parameters.put("cancel_url", "http://192.168.113.76:8080/payment/cancel"); // 취소 시 redirect url
        parameters.put("fail_url", "http://192.168.113.76:8080/payment/fail"); // 실패 시 redirect url
